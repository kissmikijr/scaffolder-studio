...
const PrefabQueenNode = ({
  ...
  const renderNode = () => {
    ...
    if (isStepNode(node)) {
      return <StepNode {...(node as any)} {...baseProps} disabled />;
    }
    if (isPropertyNode(node)) {
      return <PropertyNodeContent {...(node as any)} {...baseProps} disabled />;
    }
    if (isOutputNode(node)) {
      return <OutputNode {...(node as any)} {...baseProps} disabled />;
    }
