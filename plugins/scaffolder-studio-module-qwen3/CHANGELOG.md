...
- Updated dependencies [d218c3e]
  - @kissmiklosjr/plugin-scaffolder-studio-agent-backend@0.0.8
...
- Updated dependencies [3ccac63]
  - @kissmiklosjr/plugin-scaffolder-studio-agent-backend@0.0.7
  - @kissmiklosjr/plugin-scaffolder-studio-agent-node@0.0.7
...
- Updated dependencies [c890ac3]
  - @kissmiklosjr/plugin-scaffolder-studio-agent-backend@0.0.6
  - @kissmiklosjr/plugin-scaffolder-studio-agent-node@0.0.6
